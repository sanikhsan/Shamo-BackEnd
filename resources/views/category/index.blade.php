                        ...
                        <table class="table table-flush text-gray-900 pt-5" datatable id="ProductTable">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="font-normal leading-normal text-sm">{{$category->name}}</td>
                              <td class="font-normal leading-normal text-sm">
                                <a href="{{route('admin.category.edit', $category)}}"
                                  type="button"
                                  class="text-white bg-gray-600 hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 text-center"
                                >Edit
                                </a>
                              </td>
                              <td class="font-normal leading-normal text-sm">
