            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        ...
                        <form method="post" action="{{route('admin.product.update', $product)}}" class="mt-6 space-y-6">
                            @csrf
                            @method('patch')
                            ...
                            <div>
                                ...
                                <select id="countries" name="product_categories_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="{{$product->product_categories_id}}" selected>{{$product->Categories->name}}</option>
                            ...
                            <div>
                                ...
                                <x-text-input id="tags" name="tags" type="text" class="mt-1 block w-full" value="{{old('tags', $product->tags)}}" required autofocus autocomplete="tags" />
